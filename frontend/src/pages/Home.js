...
const buttonData = [
  { id: 0, title: "Jili", icon: <FaHome /> },
  { id: 1, title: "CQ9", icon: <FaSearch /> },
  { id: 2, title: "MG", icon:<FaUser /> },
  { id: 3, title: "PG", icon:<FaShoppingCart /> },
  { id: 4, title: "EVO", icon: <FaCog /> },
];
...
function Home() {
  ...
  const cardgridData = {
    0: [
      ...
      { image: "https://thumbs.dreamstime.com/b/view-more-icon-white-background-button-sign-flat-style-264179681.jpg" }
