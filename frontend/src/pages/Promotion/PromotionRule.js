  ...
  return (
    <div className="bg-[#242424] w-[412px] min-h-screen flex flex-col">
      ...
      <div className="bg-[#242424] min-h-screen flex flex-col items-center justify-center mt-10">
        <div className="w-[412px] bg-[#242424]  p-4 font-sans text-sm">
                ...
                <div className="flex justify-center items-center">
                  <div
                    ...
                    style={{
                      ...
                      borderBottomLeftRadius: "80px 80px", // Moves top-left towards right
                      borderTopRightRadius: "60px 0px", // Moves top-right towards left
