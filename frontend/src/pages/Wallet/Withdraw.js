...
const paymentOptions = [
  ...
  },
  {
    ...
    content: <div><div className=" bg-[#333332] rounded-lg p-4">
    <button
    ...
    >
      <span className="material-symbols-outlined text-zinc-400 text-4xl">add</span>
      <span className="text-zinc-400 mt-2">Add Address</span>
    </button>
    <p className="text-red-500 text-sm mt-2">
      Ensure that beneficiary information is correctly added before proceeding.
    </p>
  </div>
  <div className=" bg-[#333332] p-4 mt-4 rounded-2xl font-['Open_Sans']">
      <div className="flex items-center gap-2 mb-6">
        <img
          ...
          alt="USDT"
        />
        <span className="text-white font-medium">Select amount of USDT</span>
      </div>
      ...
      <div className="flex justify-between items-center mb-6">
        <span className="text-amber-500 text-sm">Withdrawable balance ₹0.00</span>
      ...
      <div className="space-y-3 text-sm">
        {[
          { text: "Need to bet ₹7700 to be able to withdraw", highlight: "text-red-500" },
          { text: "Withdraw time 00:00-23:59", highlight: "text-amber-500" },
          { text: "Inday Remaining Withdrawal Times 5", highlight: "text-red-500" },
          { text: "Withdrawal amount range ₹1,000.00 - ₹10,000,000.00", highlight: "text-red-500" },
            ...
            <span className="text-gray-300">
              {item.text.split(" ").map((word, i) =>
                word.startsWith("₹") || word.match(/\d+/) ? (
                  <span key={i} className={item.highlight || "text-gray-300"}>
                    {word}{" "}
                  </span>
                ) : (
                  word + " "
...
<div id="webcrumbs" className=" bg-[#333332] mt-4 p-4 rounded-xl">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h2 className="text-white text-lg font-medium">Withdrawal History</h2>
      </div>
